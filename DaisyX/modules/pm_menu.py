...
STICKERS = (
    "CAACAgUAAxkBAAIP9GChTmNNf0k3x5wP3sh4yX7GN93aAAKaAwACRykIVUTRq0b5ip1SHwQ", 
)
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://t.me/Riya_robot_updates"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/Riya_robot_updates"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/Riya_Robot_Support"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add Riya to your group",
            url=f"https://telegram.me/riya_robot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/Riya_robot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
